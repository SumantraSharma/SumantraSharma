<!-- ═══════════════════════════════════════════════════════════ -->
<!--         SUMANTRA RAJ SHARMA — GitHub Profile README        -->
<!-- ═══════════════════════════════════════════════════════════ -->
...
### [🛍️ Buy-Now-Central](https://github.com/SumantraSharma/Buy-Now-Central)

A modern, full-featured **clothing e-commerce platform** built for how people actually shop today — fast, mobile-first, and intuitive.

- ✅ End-to-end product discovery, cart flows & order management
- ✅ Clean component architecture with responsive UI
...
### Open to AI/ML engineering roles — NYC or remote.
**If you're building with LLMs, intelligent systems, or data-driven products, let's connect.**
